...
const CameraFeed = () => {
    ...
    const streamUrl1 = "https://finances-picks-referrals-deal.trycloudflare.com/?action=stream";
    const streamUrl2 = "https://sandy-mediterranean-outstanding-template.trycloudflare.com/?action=stream"; 
