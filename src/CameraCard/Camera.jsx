...
const CameraFeed = () => {
    ...
    const streamUrl1 = "https://romania-nhs-privileges-correction.trycloudflare.com/?action=stream";
    const streamUrl2 = "https://magazine-commit-warranties-matthew.trycloudflare.com/?action=stream"; 
