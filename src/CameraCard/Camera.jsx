...
const CameraFeed = () => {
    ...
    const streamUrl1 = "https://senators-negotiations-existed-gives.trycloudflare.com/?action=stream";
    const streamUrl2 = "https://wed-scene-between-rest.trycloudflare.com/?action=stream"; 
