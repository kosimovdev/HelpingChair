...
const CameraFeed = () => {
    ...
    const streamUrl1 = "https://parties-render-liabilities-framing.trycloudflare.com/?action=stream";
    const streamUrl2 = "https://instance-authentic-lender-criteria.trycloudflare.com/?action=stream"; 
