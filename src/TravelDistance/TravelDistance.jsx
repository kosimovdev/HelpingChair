            ...
            <div className="flex flex-col items-center justify-center">
                <div className="TravelMainDiv bg-white p-6 rounded-2xl shadow-lg w-80 text-center">
                    ...
                    <div className="relative flex items-center  m-auto mt-4">
                        <div>
                            <button onClick={handlePreviousClick} className="flex items-center justify-center rounded-full m-auto w-[80px] h-[80px] bg-[#E2E2E2]"><img className={"w-[20px]"} src={previous} alt="previousLogo"/></button>
                        </div>
                        ...
                        <div>
                            <button onClick={handleNextClick} className="flex items-center justify-center rounded-full m-auto w-[80px] h-[80px] bg-[#E2E2E2]"><img className={"w-[20px]"} src={nextLogo} alt="previousLogo"/></button>
                        </div>
                    </div>
